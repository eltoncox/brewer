...
import com.elton.brewer.model.Origem;
import com.elton.brewer.model.Sabor;
...
public class CervejasController {
	...
	public ModelAndView pesquisar(CervejaFilter cervejaFilter, BindingResult result
		...
		PageWrapper<Cerveja> paginaWrapper = new PageWrapper<Cerveja>(cervejas.filtrar(cervejaFilter, pageable)
				, httpServletRequest);
